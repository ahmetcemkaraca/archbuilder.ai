...
from app.database.session import get_sessionmaker, get_connection_stats, check_connection_health
...
class DatabaseMonitoringService:
    ...
    async def get_health_summary(self) -> Dict[str, Any]:
        ...
        success_rate = sum(1 for h in recent_health if h.is_healthy) / len(recent_health)
