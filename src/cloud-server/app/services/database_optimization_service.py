...
class DatabaseOptimizationService:
    ...
    def _update_query_metrics(self, query_hash: str, duration_ms: float, query_str: str):
    ...
    async def suggest_indexes(self, model_class: Type[DeclarativeBase]) -> List[Dict[str, Any]]:
    ...
    async def create_recommended_indexes(
        ...
        try:
            ...
            logger.error("index_creation_transaction_failed", error=str(e), exc_info=True)
            raise
    ...
    async def analyze_query_plan(
        ...
        try:
            async with session:
                ...
                # TR: Plan analizi
                analysis = self._analyze_execution_plan(query_plan[0] if query_plan else {})
    ...
    async def get_performance_summary(self) -> Dict[str, Any]:
        ...
        avg_duration = sum(m.avg_duration_ms for m in self._query_metrics.values()) / total_queries
