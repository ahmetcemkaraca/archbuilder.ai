...
class RegionalBuildingCodesService:
    ...
    def _load_building_codes_database(self) -> None:
        ...
        try:
            ...
            logger.info(f"TR: {len(self._building_codes)} bölge için yapı yönetmelikleri yüklendi")
    ...
    def _load_brazilian_building_codes(self) -> Dict[str, List[BuildingCodeRequirement]]:
    ...
    def get_building_requirements(self, region: str, building_type: str) -> List[Dict[str, Any]]:
    ...
    def validate_design_against_codes(self, design_params: Dict[str, Any], 
                                    region: str, 
        ...
        try:
            ...
            for req_dict in requirements:
                ...
                design_value = self._extract_design_value(design_params, req_code, req_dict)
    ...
    def _extract_design_value(self, design_params: Dict[str, Any], 
                            req_code: str, 
                            req_dict: Dict[str, Any]) -> Optional[float]:
    ...
    def search_requirements(self, search_term: str, 
        ...
        try:
            results = []
            regions_to_search = [region.upper()] if region else self._building_codes.keys()
            ...
            for region_code in regions_to_search:
                ...
                for building_type, requirements in region_data.items():
                    for req in requirements:
                        if (search_term.lower() in req.name.lower() or 
                            search_term.lower() in req.description.lower() or
                            search_term.lower() in req.code.lower()):
