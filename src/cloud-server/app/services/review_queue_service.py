...
class ReviewQueueService:
    ...
    async def assign_review(
        ...
        try:
            ...
            if not review_item:
                return {
                    "success": False,
                    "error": "TR: Review item bulunamadı"
                }
            ...
            return {
                "success": False,
                "error": f"TR: Review atama hatası: {str(e)}"
            }
    ...
    async def submit_review(
        ...
        try:
            ...
            if review_item.assigned_to != reviewer_id:
                return {
                    "success": False,
                    "error": "TR: Bu review size atanmamış"
                }
            ...
            if decision not in valid_decisions:
                return {
                    "success": False,
                    "error": f"TR: Geçersiz karar: {decision}"
                }
            ...
            return {
                "success": False,
                "error": f"TR: Review submit hatası: {str(e)}"
            }
    ...
    async def get_review_history(
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"TR: Review history hatası: {str(e)}"
            }
