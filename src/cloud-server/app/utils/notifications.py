...
class NotificationService:
    ...
    def __init__(self):
        ...
        self.subscriber_preferences: Dict[
            str, Dict[NotificationType, List[NotificationChannel]]
        ] = {}
    ...
    async def send_review_notification(
        ...
        notification = Notification(
            ...
            data={
                ...
                "deadline": (
                    review_item.deadline.isoformat() if review_item.deadline else None
                ),
            },
    ...
    async def _send_webhook_notification(self, notification: Notification) -> bool:
        ...
        logger.info(
            "Webhook notification gönderiliyor", recipient=notification.recipient_id
        )
